...
#[openapi(
    ...
    components(schemas(
        ...
        claude_code_routes::OauthUsageResponse,
        claude_code_routes::OauthUsageResponseStatus,
        claude_code_routes::OauthQuotaWindow,
        claude_code_routes::OauthUsageSnapshotResponse,
