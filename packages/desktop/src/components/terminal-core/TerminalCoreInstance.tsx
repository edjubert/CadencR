...
import type { TerminalCoreInstanceHandle, TerminalCoreInstanceProps } from "./TerminalCoreInstance.types";

export type { TerminalCoreInstanceHandle, TerminalCoreInstanceProps } from "./TerminalCoreInstance.types";

export const TerminalCoreInstance = forwardRef<TerminalCoreInstanceHandle, TerminalCoreInstanceProps>(
